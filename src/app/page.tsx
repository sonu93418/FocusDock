...
export default function Home() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen min-w-full h-screen w-screen bg-deep-navy flex items-center justify-center">
        <motion.div
        ...
        >
          ...
          <h2 className="text-xl font-poppins gradient-text">
            Loading FocusDock...
          </h2>
        </motion.div>
      </div>
  ...
  return (
    <main className="min-h-screen h-full w-full bg-gradient-to-br from-deep-navy via-[#0f1333] to-deep-navy">
